...
void print_result( bool *straight, bool *flush, bool *flour, bool *three, int *pairs );
...
void read_cards( int *num_in_rank, int *num_in_suit ) {
	...
	// null-out the *num_in_rank array and the *num_in_suit array and the card_exists array.
